    ...
    <div class="sidebar-scroll">
            <ul class="nav flex-column list-unstyled" id="menu">
                ...
                <li class="<?= $order_active ?>">
                    <a href="/pharmacy/orders" class="text-decoration-none px-3 py-2 d-block">
                        <i class="fa-solid fa-truck-fast icon"></i> Orders
                    </a>
                </li>
                <li class="<?= $sales_active ?>">
                    <a href="/pharmacy/sales" class="text-decoration-none px-3 py-2 d-block">
                        <span class="material-symbols-outlined fs-6 icon">sell</span> Sales
                    </a>
                </li>
