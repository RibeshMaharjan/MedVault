...
<form id="paymentForm" action="https://rc-epay.esewa.com.np/api/epay/main/v2/form" method="POST">
    ...
    <input type="text" id="success_url" name="success_url" value="http://localhost/Proj/PharmacyMgmtSys/proj-front/php/esewa/success.php" required>
    <input type="text" id="failure_url" name="failure_url" value="http://localhost/Proj/PharmacyMgmtSys/proj-front/php/esewa/failure.php" required>
